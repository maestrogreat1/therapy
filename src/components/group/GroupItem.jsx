...
const GroupItem = ({ title, img, text, reverse }) => {
  return (
    <div id="company">
      {reverse ? (
        <div className="grid grid-cols-2 justify-items-center items-center">
          ...
          >
            ...
            <p className="text-2xl w-full pt-10 pb-4 font-normal font-inter no-underline align-middle tracking-wide normal-case leading-none text-dark">
              {text}
            </p>
